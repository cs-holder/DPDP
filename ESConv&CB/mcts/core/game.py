...
from mcts.core.helpers import DialogSession, EmotionSupportDialogSession, CIMADialogSession, CBDialogSession
...
class CIMAGame(DialogGame):
	...
	S_Hint = "Hint"
	S_OpenEndedQuestion = "Open-ended Question"
	S_Others = "Others"
	...
	U_Correct = "Correctly translated"
		...
		return {
			"system": {
				"dialog_acts": [
					...
					CIMAGame.S_OpenEndedQuestion, CIMAGame.S_Others,
				],
			},
			"user": {
				"dialog_acts": [
